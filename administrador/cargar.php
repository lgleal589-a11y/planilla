...
<body>
    ...
    <div class="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="#" class="active"><i class="fas fa-building"></i> <span>Planilla</span></a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-info btn-sm btn-editar" data-id="<?= $row['id_p'] ?>"
                                data-cat="<?= $row['id_cat'] ?>" data-act="<?= $row['id_act'] ?>"
                                data-dni="<?= $row['dni'] ?>" data-prioridad="<?= $row['prioridad'] ?>"
